            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-200">
              <div>
                ...
                <select
                  ...
                  className="w-full border-gray-300 rounded-lg focus:ring-[#2DD4BF] focus:border-[#2DD4BF] cursor-pointer [&>option]:py-2 [&>option]:px-3 [&>option:hover]:bg-[#2DD4BF]/10 [&>option:hover]:text-[#2DD4BF]"
                >
                  <option value="" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Any Size</option>
                  <option value="small" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Small (≤ 20)</option>
                  <option value="medium" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Medium (21-50)</option>
                  <option value="large" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Large (50+)</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border-gray-300 rounded-lg focus:ring-[#2DD4BF] focus:border-[#2DD4BF] cursor-pointer [&>option]:py-2 [&>option]:px-3 [&>option:hover]:bg-[#2DD4BF]/10 [&>option:hover]:text-[#2DD4BF]"
                >
                  <option value="" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Any Price</option>
                  <option value="budget" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Budget (≤ $50/hr)</option>
                  <option value="mid" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Mid-Range ($51-150/hr)</option>
                  <option value="premium" className="hover:bg-[#2DD4BF]/10 hover:text-[#2DD4BF]">Premium ($150+/hr)</option>
                </select>
              </div>
            </div>
          )}
